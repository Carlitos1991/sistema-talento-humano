...
def build_notification_replacements(data):
    ...
    replacements = {
        ...
        '[NOMBRE_REVISOR]': data.get('reviewer_name', ''),
        '[CARGO_REVISOR]': data.get('reviewer_position', ''),
        '[NOMBRE_ELABORADOR]': data.get('elaborated_name', ''),
        '[CARGO_ELABORADOR]': data.get('elaborated_position', ''),
