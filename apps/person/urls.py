...
urlpatterns = [
    ...
    path('photo/update/<int:pk>/', views.PersonPhotoUpdateView.as_view(), name='person_photo_update'),
    path('detail/<int:pk>/', views.person_detail_json, name='person_detail'),
    path('audit-log/<int:pk>/', views.person_audit_log_api, name='person_audit_log'),
    path('audit-history/<int:pk>/', views.person_audit_history_partial, name='person_audit_history'),
